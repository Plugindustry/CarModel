...
public final class CarModel extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        I18n.load(Locale.SIMPLIFIED_CHINESE,
                new InputStreamReader(Objects.requireNonNull(getResource("zh_cn.lang")),
                        StandardCharsets.UTF_8));
        I18n.load(Locale.US, new InputStreamReader(Objects.requireNonNull(getResource("en_us.lang")),
                StandardCharsets.UTF_8));
        ...
        RecipeRegistry.register(
                ShapedRecipeFactory.create().pattern("aaa", "nsn", "nsn").map('a', ConstItem.TEST_ITEM)
                                   .map('s', new ItemStack(Material.STICK)).build(ConstItem.TEST_TOOL),
                "cm/test_tool_recipe", false);
